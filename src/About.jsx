    ...
    return (
        <div id='about' className='w-full  p-10 h-full  '>
            <div className='flex  mt-40 h-full gap-20 mx-auto   flex-col lg:flex-row md:flex-row'>
                <p className='border-4 h-[400px]   w-full border-cyan-500 shadow-[1px_1px_40px_-15px_cyan] 	  rounded-2xl '>
                ...
                <div className=' flex items-center   justify-center  space-y-4'>
                    <div className='space-y-5'>
                        <div className='space-y-2'>
                            <p className='text-3xl text-center lg:text-start md:text-start font-bold text-white'>About <span className=' bg-none  text-cyan-500'>Me</span></p>
                            <p className='text-xl text-center lg:text-start md:text-start  font-semibold text-white'>Frontend Developer</p>
                        </div>
                        <div className='text-center lg:text-left md:text-left text-white'>
                        ...
                        <button className= 'mt-5 bg-cyan-500 border-cyan-500 shadow-[1px_80px_80px_-15px_cyan] border-4 text-black rounded-3xl px-4 py-2  font-bold '>
                            Read More
                        </button>
                    </div>
                </div>
