    ...
    const navtext = <>
        ...
        <li>
            <NavLink to={'/'} className={({isActive}) =>
                isActive ? '   rounded-xl  text-blue-500     hover:text-blue-500    my-2 lg:my-0 md:my-0 ' : "block my-2 lg:my-0 md:my-0   text-white  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-500 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent "} >
                Home</NavLink>
        </li>
        <li>
        ...
        <div>
            ...
            <nav class=" dark:bg-gray-900">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <button>
                    {navBtn?<FiAlignJustify onClick={handleNav} className='md:hidden lg:hidden block text-white' size={25} />:''}
                    {
                                toggleNav?<div className=''>
                                    <button>
                                    </button>
                                    <ul className='flex-col font-bold bg-blue-900 bg-opacity-80 w-[100px] absolute right-0 top-5'>
                                    <FiX onClick={handleCross} size={25} className=' relative left-[60%] text-white mb-3'  />
